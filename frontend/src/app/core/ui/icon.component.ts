...
/**
 * Icon set sourced from lucide.dev (ISC license). Each path is inlined so
 * we ship no runtime dependency. Strokes use currentColor so the icon
 * inherits whatever text colour the parent has.
 */
...
const PATHS: Record<IconName, string> = {
  ...
  'party-popper':
    '<path d="M5.8 11.3 2 22l10.7-3.79"/><path d="M4 3h.01"/><path d="M22 8h.01"/><path d="M15 2h.01"/><path d="M22 20h.01"/><path d="M22 2 17 17l-5-5 5-5"/><path d="m18 21 1-1"/><path d="M9 13 7 7l6 2-2 4"/><path d="m11 7 1-2"/><path d="M3 11h2"/>',
  pause:
...
export class IconComponent {
  ...
  // PATHS are static, author-controlled SVG fragments — safe to trust.
  // Required because Angular's default sanitizer strips SVG sub-elements
  // when bound through [innerHTML].
