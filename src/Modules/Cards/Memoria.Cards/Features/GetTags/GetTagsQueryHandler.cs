...
internal sealed class GetTagsQueryHandler : IRequestHandler<GetTagsQuery, Result<IReadOnlyList<TagDto>>>
{
    private readonly CardsDbContext _db;

    public GetTagsQueryHandler(CardsDbContext db)
    {
