...
internal sealed class GetGlobalRatingDistributionQueryHandler
    : IRequestHandler<GetGlobalRatingDistributionQuery, Result<RatingDistributionDto>>
{
    ...
    public GetGlobalRatingDistributionQueryHandler(ReviewsDbContext db, TimeProvider clock)
    {
    ...
    public async Task<Result<RatingDistributionDto>> Handle(
        GetGlobalRatingDistributionQuery request, CancellationToken ct)
    {
